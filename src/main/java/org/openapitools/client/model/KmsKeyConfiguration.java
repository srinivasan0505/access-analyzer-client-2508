...
public class KmsKeyConfiguration {
  ...
  public KmsKeyConfiguration keyPolicies(@javax.annotation.Nullable Map keyPolicies) {
  ...
  public KmsKeyConfiguration grants(@javax.annotation.Nullable List grants) {
    this.grants = grants;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    KmsKeyConfiguration kmsKeyConfiguration = (KmsKeyConfiguration) o;
    return Objects.equals(this.keyPolicies, kmsKeyConfiguration.keyPolicies) &&
        Objects.equals(this.grants, kmsKeyConfiguration.grants);
  }
  ...
  public String toString() {
    ...
    sb.append("class KmsKeyConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KmsKeyConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KmsKeyConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KmsKeyConfiguration is not found in the empty JSON string", KmsKeyConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KmsKeyConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KmsKeyConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KmsKeyConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KmsKeyConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KmsKeyConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KmsKeyConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<KmsKeyConfiguration>() {
           @Override
           public void write(JsonWriter out, KmsKeyConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KmsKeyConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KmsKeyConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KmsKeyConfiguration
   * @throws IOException if the JSON string is invalid with respect to KmsKeyConfiguration
   */
  public static KmsKeyConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KmsKeyConfiguration.class);
  }

  /**
   * Convert an instance of KmsKeyConfiguration to an JSON string
   *
   * @return JSON string
   */
