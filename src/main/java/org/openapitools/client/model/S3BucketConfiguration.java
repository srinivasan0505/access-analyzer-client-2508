...
public class S3BucketConfiguration {
  ...
  public S3BucketConfiguration bucketPolicy(@javax.annotation.Nullable String bucketPolicy) {
  ...
  public S3BucketConfiguration bucketAclGrants(@javax.annotation.Nullable List bucketAclGrants) {
  ...
  public S3BucketConfiguration bucketPublicAccessBlock(@javax.annotation.Nullable S3BucketConfigurationBucketPublicAccessBlock bucketPublicAccessBlock) {
  ...
  public S3BucketConfiguration accessPoints(@javax.annotation.Nullable Map accessPoints) {
  ...
  public boolean equals(Object o) {
    ...
    S3BucketConfiguration s3BucketConfiguration = (S3BucketConfiguration) o;
    return Objects.equals(this.bucketPolicy, s3BucketConfiguration.bucketPolicy) &&
        Objects.equals(this.bucketAclGrants, s3BucketConfiguration.bucketAclGrants) &&
        Objects.equals(this.bucketPublicAccessBlock, s3BucketConfiguration.bucketPublicAccessBlock) &&
        Objects.equals(this.accessPoints, s3BucketConfiguration.accessPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class S3BucketConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3BucketConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3BucketConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3BucketConfiguration is not found in the empty JSON string", S3BucketConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3BucketConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3BucketConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3BucketConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3BucketConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3BucketConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3BucketConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<S3BucketConfiguration>() {
           @Override
           public void write(JsonWriter out, S3BucketConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3BucketConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3BucketConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3BucketConfiguration
   * @throws IOException if the JSON string is invalid with respect to S3BucketConfiguration
   */
  public static S3BucketConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3BucketConfiguration.class);
  }

  /**
   * Convert an instance of S3BucketConfiguration to an JSON string
   *
   * @return JSON string
   */
