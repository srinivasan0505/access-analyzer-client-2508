...
/**
 * Gets or Sets KmsGrantOperation
 */
@JsonAdapter(KmsGrantOperation.Adapter.class)
public enum KmsGrantOperation {
  ...
  KmsGrantOperation(String value) {
    this.value = value;
  }
  ...
  public static KmsGrantOperation fromValue(String value) {
    for (KmsGrantOperation b : KmsGrantOperation.values()) {
  ...
  public static class Adapter extends TypeAdapter<KmsGrantOperation> {
    @Override
    public void write(final JsonWriter jsonWriter, final KmsGrantOperation enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public KmsGrantOperation read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return KmsGrantOperation.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    KmsGrantOperation.fromValue(value);
  }
}
