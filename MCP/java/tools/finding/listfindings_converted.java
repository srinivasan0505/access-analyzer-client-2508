...
class Post_FindingMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_FindingHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort")) {
            queryParams.add("sort=" + args.get("sort"));
        }
        if (args.containsKey("filter")) {
            queryParams.add("filter=" + args.get("filter"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_finding" + queryString;
    ...
    public static MCPServer.Tool createPost_FindingTool(MCPServer.APIConfig config) {
        ...
        analyzerArnProperty.put("description", "Input parameter: The <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources\">ARN of the analyzer</a> to retrieve findings from.");
        properties.put("analyzerArn", analyzerArnProperty);
        Map<String, Object> sortProperty = new HashMap<>();
        sortProperty.put("type", "string");
        sortProperty.put("required", false);
        sortProperty.put("description", "Input parameter: The criteria used to sort.");
        properties.put("sort", sortProperty);
        Map<String, Object> filterProperty = new HashMap<>();
        filterProperty.put("type", "string");
        filterProperty.put("required", false);
        filterProperty.put("description", "Input parameter: A filter to match for the findings to return.");
        ...
        return new MCPServer.Tool(definition, getPost_FindingHandler(config));
    }
