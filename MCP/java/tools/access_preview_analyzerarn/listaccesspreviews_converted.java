/**
 * MCP Server function for Retrieves a list of access previews for the specified analyzer.
 */
...
class Get_Access_Preview_Analyzer_ArnMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Access_Preview_Analyzer_ArnHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("maxResults")) {
            queryParams.add("maxResults=" + args.get("maxResults"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_access_preview_analyzer_arn" + queryString;
    ...
    public static MCPServer.Tool createGet_Access_Preview_Analyzer_ArnTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_access_preview_analyzer_arn",
            "Retrieves a list of access previews for the specified analyzer.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Access_Preview_Analyzer_ArnHandler(config));
    }
