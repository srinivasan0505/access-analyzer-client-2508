/**
 * MCP Server function for Retrieves a list of analyzers.
 */
...
class Get_AnalyzerMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_AnalyzerHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("maxResults")) {
            queryParams.add("maxResults=" + args.get("maxResults"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_analyzer" + queryString;
    ...
    public static MCPServer.Tool createGet_AnalyzerTool(MCPServer.APIConfig config) {
        ...
        typeProperty.put("description", "The type of analyzer.");
        ...
        return new MCPServer.Tool(definition, getGet_AnalyzerHandler(config));
    }
