...
func ListanalyzedresourcesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListAnalyzedResourcesrequest
		...
		url := fmt.Sprintf("%s/analyzed-resource%s", cfg.BaseURL, queryString)
		...
		var result models.ListAnalyzedResourcesResponse
...
func CreateListanalyzedresourcesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_analyzed-resource",
		mcp.WithDescription("Retrieves a list of resources of the specified type that have been analyzed by the specified analyzer.."),
		...
		mcp.WithString("nextToken", mcp.Description("Input parameter: A token used for pagination of results returned.")),
		mcp.WithString("resourceType", mcp.Description("Input parameter: The type of resource.")),
		mcp.WithString("analyzerArn", mcp.Required(), mcp.Description("Input parameter: The <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources\">ARN of the analyzer</a> to retrieve a list of analyzed resources from.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ListanalyzedresourcesHandler(cfg),
	}
}
