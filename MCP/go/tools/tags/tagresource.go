...
func CreateTagresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_tags_resourceArn",
		mcp.WithDescription("Adds a tag to the specified resource."),
		...
		mcp.WithString("resourceArn", mcp.Required(), mcp.Description("The ARN of the resource to add the tag to.")),
