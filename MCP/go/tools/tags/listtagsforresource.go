...
func CreateListtagsforresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_tags_resourceArn",
		mcp.WithDescription("Retrieves a list of tags applied to the specified resource."),
		...
		mcp.WithString("resourceArn", mcp.Required(), mcp.Description("The ARN of the resource to retrieve tags from.")),
	)
