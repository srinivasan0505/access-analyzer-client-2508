...
func CreatearchiveruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateArchiveRulerequest
		...
		url := fmt.Sprintf("%s/analyzer/%s/archive-rule", cfg.BaseURL, analyzerName)
...
func CreateCreatearchiveruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_analyzer_analyzerName_archive-rule",
		...
		mcp.WithString("analyzerName", mcp.Required(), mcp.Description("The name of the created analyzer.")),
		mcp.WithString("ruleName", mcp.Required(), mcp.Description("Input parameter: The name of the rule to create.")),
		mcp.WithString("clientToken", mcp.Description("Input parameter: A client token.")),
		mcp.WithObject("filter", mcp.Required(), mcp.Description("Input parameter: The criteria for the rule.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CreatearchiveruleHandler(cfg),
	}
}
