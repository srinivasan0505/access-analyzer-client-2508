...
func GetarchiveruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetArchiveRuleResponse
...
func CreateGetarchiveruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_analyzer_analyzerName_archive-rule_ruleName",
		...
		mcp.WithString("ruleName", mcp.Required(), mcp.Description("The name of the rule to retrieve.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetarchiveruleHandler(cfg),
	}
}
