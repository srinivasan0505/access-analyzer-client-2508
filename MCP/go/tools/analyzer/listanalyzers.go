...
func ListanalyzersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/analyzer%s", cfg.BaseURL, queryString)
		...
		var result models.ListAnalyzersResponse
...
func CreateListanalyzersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_analyzer",
		mcp.WithDescription("Retrieves a list of analyzers."),
		...
		mcp.WithString("type", mcp.Description("The type of analyzer.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ListanalyzersHandler(cfg),
	}
}
