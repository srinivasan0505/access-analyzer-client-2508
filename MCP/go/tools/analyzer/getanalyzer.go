...
func GetanalyzerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/analyzer/%s", cfg.BaseURL, analyzerName)
		...
		var result models.GetAnalyzerResponse
...
func CreateGetanalyzerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_analyzer_analyzerName",
		mcp.WithDescription("Retrieves information about the specified analyzer."),
		...
		mcp.WithString("analyzerName", mcp.Required(), mcp.Description("The name of the analyzer retrieved.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetanalyzerHandler(cfg),
	}
}
