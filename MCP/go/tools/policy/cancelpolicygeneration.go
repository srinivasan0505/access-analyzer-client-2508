...
func CancelpolicygenerationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/policy/generation/%s", cfg.BaseURL, jobId)
		...
		var result models.CancelPolicyGenerationResponse
...
func CreateCancelpolicygenerationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_policy_generation_jobId",
		mcp.WithDescription("Cancels the requested policy generation."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CancelpolicygenerationHandler(cfg),
	}
}
