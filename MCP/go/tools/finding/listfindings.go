...
func ListfindingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListFindingsrequest
		...
		url := fmt.Sprintf("%s/finding%s", cfg.BaseURL, queryString)
		...
		var result models.ListFindingsResponse
...
func CreateListfindingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_finding",
		...
		mcp.WithObject("sort", mcp.Description("Input parameter: The criteria used to sort.")),
		mcp.WithString("analyzerArn", mcp.Required(), mcp.Description("Input parameter: The <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources\">ARN of the analyzer</a> to retrieve findings from.")),
		mcp.WithObject("filter", mcp.Description("Input parameter: A filter to match for the findings to return.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListfindingsHandler(cfg),
	}
}
