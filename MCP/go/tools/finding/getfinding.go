...
func GetfindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/finding/%s#analyzerArn%s", cfg.BaseURL, id, queryString)
		...
		var result models.GetFindingResponse
...
func CreateGetfindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_finding_id#analyzerArn",
		mcp.WithDescription("Retrieves information about the specified finding."),
		...
		mcp.WithString("analyzerArn", mcp.Required(), mcp.Description("The <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources\">ARN of the analyzer</a> that generated the finding.")),
		mcp.WithString("id", mcp.Required(), mcp.Description("The ID of the finding to retrieve.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetfindingHandler(cfg),
	}
}
