...
func ListaccesspreviewsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/access-preview#analyzerArn%s", cfg.BaseURL, queryString)
		...
		var result models.ListAccessPreviewsResponse
...
func CreateListaccesspreviewsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_access-preview#analyzerArn",
		mcp.WithDescription("Retrieves a list of access previews for the specified analyzer."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListaccesspreviewsHandler(cfg),
	}
}
