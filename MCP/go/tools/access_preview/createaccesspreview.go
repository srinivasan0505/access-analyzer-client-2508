...
func CreateaccesspreviewHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateAccessPreviewrequest
		...
		url := fmt.Sprintf("%s/access-preview", cfg.BaseURL)
		...
		var result models.CreateAccessPreviewResponse
...
func CreateCreateaccesspreviewTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_access-preview",
		mcp.WithDescription("Creates an access preview that allows you to preview IAM Access Analyzer findings for your resource before deploying resource permissions."),
